Contributing to docker-cikl-logstash
============================

You're encouraged to submit [pull requests](https://github.com/cikl/docker-cikl-logstash/pulls), [propose features and discuss issues](https://github.com/cikl/docker-cikl-logstash/issues).

#### Fork the Project

Fork the [project on Github](https://github.com/cikl/docker-cikl-logstash) and check out your copy.

```
git clone https://github.com/contributor/docker-cikl-logstash.git
cd cikl
git remote add upstream https://github.com/cikl/docker-cikl-logstash.git
```
...
Go to https://github.com/contributor/docker-cikl-logstash and select your feature branch. Click the 'Pull Request' button and fill out the form. Pull requests are usually reviewed within a few days.
...
```
* [#123](https://github.com/cikl/docker-cikl-logstash/pull/123): Reticulated splines - [@contributor](https://github.com/contributor).
```
